const viewCounterSingleSelector =
  "div.css-1dbjc4n.r-2sztyj.r-1efd50x.r-5kkj8d.r-13awgt0.r-18u37iz.r-tzz3ar.r-s1qlax.r-1yzf0co > div.css-1dbjc4n"; //View counter for: Single tweet without replies
...
let observer = new MutationObserver((mutations) => {
  ...
  if (analyticElements) {
    ...
    const tweetViewElements = analyticElements.closest(
      tweetViewsSelectors.join(", ")
    );
